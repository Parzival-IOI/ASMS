...
public class SecurityConfig {
    ...
    private final UserImplementService userImplementService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        authenticationManagerBuilder.userDetailsService(userImplementService).passwordEncoder(bCryptPasswordEncoder());
